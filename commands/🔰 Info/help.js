  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('Get your Own Bot').setURL("https://discord.gg/HsFVamFb4N")
        let button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://www.youtube.com/channel/UCtpA93OoN2aP_8xJS0DuGSg")
        ...
        let FIRSTEMBED = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter("Page Home\n" + client.user.username + " | Made By Tennessine07 ", client.user.displayAvatarURL())
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)
        ...
        let d_button_dc = new MessageButton().setStyle('url').setLabel('Get your Own Bot').setURL("https://discord.gg/HsFVamFb4N");
        let d_button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://www.youtube.com/channel/UCtpA93OoN2aP_8xJS0DuGSg");
      ...
      function allotherembeds() {
        ...
        var embed5 = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setTitle("<:Tennessine07:840259659163893820> Bot Creator")

          .addField(`> ***[Tennessine07](https://discord.gg/HsFVamFb4N)***\n>`)
          .addField(`<:Tennessine07:840259659163893820> **__Bot Creator Information__**`, `>>> 💯 This Bot has been made by VSC :\n[Discord](https://discord.gg/HsFVamFb4N)<:Discord:840259659163893820>`)
          .setFooter(`Page 6 / 6  \nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL());
        embeds.push(embed5)
        return embeds
      }
